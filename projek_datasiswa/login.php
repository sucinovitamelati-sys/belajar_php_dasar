...
if (isset($_POST['login'])) {
    ...
    // Ambil id, nama, email, dan pasword berdasarkan email
    $query = mysqli_query($conn, "SELECT id, nama, email, pasword FROM `user` WHERE email='$email'");
    $data = mysqli_fetch_assoc($query);

    // Cek akun dan password
    if ($data && $pasword == $data['pasword']) {
...
<head>
    ...
    <title>Login - MelatiSchool</title>
    <style>
